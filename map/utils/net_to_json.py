...
xmldoc = minidom.parse('/home/ubuntu/NewYork/map/sumo/map.net.xml')
...
print string
f=open("/home/ubuntu/NewYork/map/tables/out.json","w")
f.write(string)
os.system('rm /home/ubuntu/NewYork/map/sumo/sumo_tables/*')